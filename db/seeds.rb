...
puts "Grupo AX"
mobi  = grupo_ax.cars.create!(name: 'Mobi Like', price: 120, rented: false, url_image: 'https://storage.googleapis.com/movida-public-images/modelos/3210_image.png')
up    = grupo_ax.cars.create!(name: 'WV UP Extreme', price: 120, rented: false, url_image: 'https://quatrorodas.abril.com.br/wp-content/uploads/2020/12/Volkswagen-Up-Xtreme-2021-3-e1617836833976.jpg')
kwid  = grupo_ax.cars.create!(name: 'Kwid-Intense', price: 120, rented: false, url_image: 'https://bestcars.com.br/bc/wp-content/uploads/2018/05/Renault-Kwid-Intense-16.jpg')
mirca = grupo_ax.cars.create!(name: 'Nissan Micra', price: 120, rented: false, url_image: 'https://www.oficinabrasil.com.br/uploads/1.4e.jpg')
